...
.equ	VALORCONTADOR1 = 250
.equ	VALORCONTADOR2 = 2
...
start:
        ...
        out DDRB, r23
        out PORTB, r23
		ldi r19, VALORCONTADOR1
		ldi r18, VALORCONTADOR2
...
OC0A_IRQSRV	:
				...
				ldi r19, VALORCONTADOR1		//	Here every 2 x 250 ms = 500ms

				dec r18
				brne endisr

				ldi	r19, VALORCONTADOR1			//	Here every 500 x 2 ms = 1000ms
				ldi r18, VALORCONTADOR2
